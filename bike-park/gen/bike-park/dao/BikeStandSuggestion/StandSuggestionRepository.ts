...
export class StandSuggestionRepository {
    ...
    private async triggerEvent(data: StandSuggestionEntityEvent | StandSuggestionUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("bike-park-BikeStandSuggestion-StandSuggestion", ["trigger"]);
        ...
        producer.topic("bike-park-BikeStandSuggestion-StandSuggestion").send(JSON.stringify(data));
    }
}
