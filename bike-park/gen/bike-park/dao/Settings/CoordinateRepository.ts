...
export class CoordinateRepository {
    ...
    private async triggerEvent(data: CoordinateEntityEvent | CoordinateUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("bike-park-Settings-Coordinate", ["trigger"]);
        ...
        producer.topic("bike-park-Settings-Coordinate").send(JSON.stringify(data));
    }
}
