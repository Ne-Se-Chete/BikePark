...
export class StandTypeRepository {
    ...
    private async triggerEvent(data: StandTypeEntityEvent | StandTypeUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("bike-park-Settings-StandType", ["trigger"]);
        ...
        producer.topic("bike-park-Settings-StandType").send(JSON.stringify(data));
    }
}
