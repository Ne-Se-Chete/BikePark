...
const validationModules = await Extensions.loadExtensionModules("bike-park-Settings-Coordinate", ["validate"]);
...
class CoordinateService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/bike-park/gen/bike-park/api/Settings/CoordinateService.ts/" + entity.Id);
