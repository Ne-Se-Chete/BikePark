...
export class ApiKeyRepository {
    ...
    private async triggerEvent(data: ApiKeyEntityEvent | ApiKeyUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("BikePark-Settings-ApiKey", ["trigger"]);
        ...
        producer.topic("BikePark-Settings-ApiKey").send(JSON.stringify(data));
    }
}
